    ...
    <div class="d-flex justify-content-between my-auto" id="">
      ...
      <h3 class='d-flex align-items-center'>
        <form action="" class="" method="post">
          ...
          <input type="text" class="h3 edit-input w-auto border-0 bg-transparent rounded p-1" name="folder-name" id=""
            value="<?= htmlentities($folder_name) ?>">
      ...
      <a href='./?folder_delete_id=<?= $folder_id ?>' class='p-2 d-flex my-auto' id=''>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="dark" class="bi bi-trash align-self-center"
          viewBox="0 0 16 16" id="delete-folder-button">
          <path
            ...
            <div class='modal-content px-5 pt-4'>
              ...
              <div class='modal-body px-0 mb-2'>
                <form action="" method="post">
                  <input type="text" class="h3 edit-input w-auto border-0 bg-transparent rounded p-1 ms-1"
                    name="edit-todo-title" value="<?= $todo["title"] ?>">
                  <input type="number" class="h3 edit-input w-auto border-0 bg-transparent rounded p-1 d-none"
                    name="edit-todo-id" value="<?= $todo["id"] ?>">
                ...
                <ul class='list-group list-group-flush justify-content-center d-flex gap-1'>
                  ...
                  <div class="d-flex justify-content-between border rounded px-2 py-2 align-items-center">
                    <div class="flex-grow-1">
                      <li class='list-group-item border-0 p-0 d-flex gap-2 align-items-center'>
                        ...
                        <form action="" class="w-100" method="post">
                          <input type="text" name="edit-sub-content"
                            class="edit-input w-100 border-0 bg-transparent rounded p-1"
                            value="<?= $sub_todo["content"] ?>">
                    ...
                    <div>
                      <a href='./?sub_delete_id=<?= $sub_todo["id"] ?>'
                        class='p-2 border-1 border-left-0 rounded-end d-flex' id=''>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="dark"
                          class="bi bi-trash align-self-center" viewBox="0 0 16 16" id="sub-todo-delete">
                          <path
                            d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
                          <path fill-rule="evenodd"
                            d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z" />
